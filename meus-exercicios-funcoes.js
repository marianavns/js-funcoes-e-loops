...
/*####### DIVISAO #######*/
 ...
 /*####### MULTIPLICAÇAO COM CONDICAO #######*/

console.log("==== Multiplicando dois numeros ==== Valores iguais a zero nao sao permitidos ====")
...
let valor2 = input.question("Digite o segundo numero: ")
    ...
    const multiplica = function (num1, num2){
        if (num1 == 0 || num2 == 0){
            console.log("[X] Valores iguais a zero nao sao aceitos.")
            } else {
        let resultado = num1 * num2
        console.log("A multiplicacao dos numeros " + valor1 + " e " + valor2 + " é igual a " + resultado)
                }
    }
...
/* ####### DIVISÃO COM CONDIÇÃO #######*/ 

console.log("==== Dividindo dois numeros ==== Valores iguais a zero nao sao permitidos ====")
    ...
    function divide (num1, num2){
        if (num1 == 0 || num2 == 0){
            console.log("[X] Valores iguais a zero nao sao aceitos")
                ...
                let resultado = num1 / num2
                console.log("A divisao do primeiro número (" + valor1 + ") pelo segundo (" + valor2 + ") é igual a " + resultado) 
        }
    }
